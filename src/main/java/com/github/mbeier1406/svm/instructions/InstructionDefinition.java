 ...
 * gehören auch desse/deren Parameter (asl Array von Bytes) zur vollständigen Darstellung im Speicher
 * <p>
 ...
 */
public record InstructionDefinition<T>(InstructionInterface<T> instruction, byte[] params, int len) {
