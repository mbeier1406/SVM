...
/**
 * Definiert die Funktion zur lexikalischen Analyse eines {@linkplain TokenType#DOT}.
 */
public class DotLexer {
	...
	public static final TokenTypeLexer TOKEN_SCANNER = (symbolList, tokenValue, lastTokenType) -> {
		...
		return TokenType.DOT; // Damit im nähsten Schritt der Label (.label) ermittelt werden kann
	};
