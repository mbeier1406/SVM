...
public class InstructionWriterShortTest {
	...
	public void testeInstruction2Array(InstructionInterface<Short> instr, byte[] params, Short[] speicherErwartet) throws SVMException {
	...
	/** Liefert die Testfälle: 1. die Instruktion mit Parametern 2. die erwartete Bytefolge */
	public static Stream<Arguments> getTestParameter() {
		return Stream.of(
				Arguments.of(INSTRUCTIONS.get(
						Mov.CODE),
