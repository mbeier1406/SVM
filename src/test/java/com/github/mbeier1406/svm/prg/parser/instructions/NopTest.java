...
public class NopTest {
	...
	public void testeNullParameter() {
		var ex = assertThrows(NullPointerException.class, () -> nop.getVirtualInstruction(null, null, null));
	...
	public void testeFalscheZahlParameter() {
		var ex = assertThrows(SVMException.class, () -> nop.getVirtualInstruction(null, new LineInfo(1, "", incorrectSymbols), null));
	...
	public void testeFalschesSymbol() {
		var ex = assertThrows(SVMException.class, () -> nop.getVirtualInstruction(null, new LineInfo(1, "", incorrectSymbolsNop), null));
	...
	public void testeOhneLabel() throws SVMException {
		var virtualInstruction = nop.getVirtualInstruction(null, new LineInfo(1, "	nop", correctSymbols), null);
	...
	public void testeMitLabel() throws SVMException {
		var virtualInstruction = nop.getVirtualInstruction(new Symbol(Token.LABEL, "label1"), new LineInfo(1, "	nop", correctSymbols), null);
		assertAll("virtualInstruction",
				() -> assertEquals(virtualInstruction.instruction(), new InstructionDefinition<>(InstructionFactory.NOP, new byte[0], null)),
